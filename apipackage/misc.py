...
class misc:
    ...
    def getalltargets(usrdef_sship, sid):
        ...
        get_targets_result = post.api_call(usrdef_sship, 443, 'show-gateways-and-servers', get_targets_data ,sid)
    ...
    def runscript(usrdef_sship, target, name, command, sid):
        ...
        get_targets_result = post.api_call(usrdef_sship, 443, 'run-script', run_script_data , sid)
    ...
    def putfile(usrdef_sship, target, path, name, contents, sid):
        ...
        put_file_result = post.api_call(usrdef_sship, 443, 'put-file', put_file_data , sid)
