...
class host:
    ...
    def addhost(usrdef_sship, hostname, hostip, hostcolor, sid):
        ...
        new_host_result = post.api_call(usrdef_sship, 443,'add-host', new_host_data ,sid)
    ...
    def addhostgroup(usrdef_sship, hostname, groupname, sid):
        ...
        addhostgroup_result = post.api_call(usrdef_sship, 443,'set-host', addhostgroup_data, sid)

    #Method to retrieve all hosts
    def getallhosts(usrdef_sship, sid):
        show_hosts_data = {'offset':0, 'details-level':'standard'}
        show_hosts_result = post.api_call(usrdef_sship, 443, 'show-hosts', show_hosts_data ,sid)
